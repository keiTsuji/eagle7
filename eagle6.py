...
# 🎨 タイトル装飾
st.markdown("""
<div style='text-align:center; background-color:#f0f8ff; padding:15px; border-radius:15px;'>
    <h1 style='font-size:36px; color:#2e8b57; font-weight:bold;'>🏌️‍♂️ イーグル会ベット計算機 🏌️‍♀️</h1>
    <p style='font-size:18px; color:#555;'>ゴルフ仲間とのベット計算がサクッとわかる！</p>
</div>
""", unsafe_allow_html=True)
